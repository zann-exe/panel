 ...
 */
const __filenameCompat = function filename(pathURL = __filename, rmPrefix = os.platform() !== 'win32') {
...
/** @param {ImportMeta | string} pathURL */
const __dirnameCompat = function dirname(pathURL) {
    const dir = __filenameCompat(pathURL, true)
    const regex = /\/$/
...
const __require = function require(dir = __filename) {
...
module.exports = {
    __filename: __filenameCompat,
    __dirname: __dirnameCompat,
    __require,
    checkFileExists,
    API,
