...
// index.js adalah satu-satunya pemilik lifecycle SIGINT/SIGTERM karena
// shutdown Baileys perlu menunggu saveCreds() sebelum process.exit().
// db.js hanya melakukan flush saat Node benar-benar keluar.
process.on('exit', flush);

export function flushNow() { flush(); }
export function stopFlushTimer() { clearInterval(flushTimer); }
