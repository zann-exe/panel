...
## Runtime check
Cannot complete runtime startup in this isolated environment: dependencies are not installed; first missing module: yargs.
...
- No JavaScript syntax errors were detected by `node --check` across the source tree.
